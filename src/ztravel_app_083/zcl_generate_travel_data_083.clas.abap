CLASS zcl_generate_travel_data_083 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_083 IMPLEMENTATION.

    METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_083.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_083.

*   insert the new table entries
    INSERT ztravel_083 FROM TABLE @itab.
