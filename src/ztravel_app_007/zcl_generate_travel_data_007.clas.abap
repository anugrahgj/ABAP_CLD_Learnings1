CLASS zcl_generate_travel_data_007 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_007 IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_007.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_007.

*   insert the new table entries
    INSERT ztravel_007 FROM TABLE @itab.
