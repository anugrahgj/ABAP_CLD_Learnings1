...
define view entity ZI_RAP_BOOKING_0001
  as select from ZRAP_ABOOK_0001
  association to parent ZI_RAP_Travel_0001 as _Travel on $projection.TravelUUID = _Travel.TravelUUID
