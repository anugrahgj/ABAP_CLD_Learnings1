 ...
 CLASS ltcl_integration_test DEFINITION FINAL FOR TESTING
    ...
    CLASS ltcl_integration_test IMPLEMENTATION.
     ...
     METHOD create_travel.
      ...
      DATA travels_in TYPE TABLE FOR CREATE zi_rap_travel_U_123\\travel.
      ...
      travels_in = VALUE #(     ( agencyid      = 070001   "Agency 070001 does exist, Agency 1 does not exist
                                ...
                                totalprice    = 330
                                currencycode  = 'EUR'
                                description   = |Test travel XYZ BY RD|
                               ) ).

      MODIFY ENTITIES OF zi_rap_travel_u_123
        ENTITY travel
      ...
      SELECT * FROM zi_rap_travel_u_123 WHERE TravelId = @new_travel_id INTO TABLE @DATA(lt_travel)  .
    ...
    METHOD class_setup.
      cds_test_environment = cl_cds_test_environment=>create_for_multiple_cds(
          i_for_entities = VALUE #( ( i_for_entity = 'zi_rap_travel_u_123' )
                                  ( i_for_entity = 'zi_rap_booking_u_123' ) )
                                ).
    ENDMETHOD.
