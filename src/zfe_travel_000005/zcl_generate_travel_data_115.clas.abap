CLASS zcl_generate_travel_data_115 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_GENERATE_TRAVEL_DATA_115 IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_115.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_115.

*   insert the new table entries
    INSERT ztravel_115 FROM TABLE @itab.
