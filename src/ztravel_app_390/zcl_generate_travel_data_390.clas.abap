CLASS zcl_generate_travel_data_390 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_390 IMPLEMENTATION.
METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_390.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_390.

*   insert the new table entries
    INSERT ztravel_390 FROM TABLE @itab.
