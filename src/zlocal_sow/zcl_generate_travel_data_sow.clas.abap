CLASS zcl_generate_travel_data_sow DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_sow IMPLEMENTATION.
METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_sow.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_sow.

*   insert the new table entries
    INSERT ztravel_sow FROM TABLE @itab.
