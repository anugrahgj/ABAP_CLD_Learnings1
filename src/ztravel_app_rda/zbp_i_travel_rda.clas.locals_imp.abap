CLASS lhc_Travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    ...
    TYPES tt_travel_update TYPE TABLE FOR UPDATE zi_travel_RDA.
...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD validate_customer.
    ...
    READ ENTITY zi_travel_RDA\\travel FROM VALUE #(
  ...
  METHOD set_status_completed.
    ...
    READ ENTITIES OF zi_travel_RDA IN LOCAL MODE
         ENTITY travel
  ...
  METHOD get_features.
    ...
    READ ENTITY zi_travel_RDA FROM VALUE #( FOR keyval IN keys
                                                      (  %key = keyval-%key
