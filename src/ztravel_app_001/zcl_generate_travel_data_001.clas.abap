CLASS zcl_generate_travel_data_001 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_GENERATE_TRAVEL_DATA_001 IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_001.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_001.

*   insert the new table entries
    INSERT ztravel_001 FROM TABLE @itab.
