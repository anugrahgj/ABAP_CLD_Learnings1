...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD get_instance_features.
    ...
    READ ENTITIES OF zi_rap_travel_341 IN LOCAL MODE
      ENTITY Travel
  ...
  METHOD acceptTravel.
    ...
    MODIFY ENTITIES OF zi_rap_travel_341 IN LOCAL MODE
      ENTITY Travel
         UPDATE
           FIELDS ( TravelStatus )
      ...
      IF travel-AgencyID IS INITIAL OR NOT line_exists( agencies_db[ agency_id = travel-AgencyID ] ).
        ...
        APPEND VALUE #( %tky        = travel-%tky
                        ...
                        %msg        = NEW zcm_rap_341(
                                          ...
                                          textid   = zcm_rap_341=>agency_unknown
    ...
    LOOP AT travels INTO DATA(travel).
      ...
      IF travel-CustomerID IS INITIAL OR NOT line_exists( customers_db[ customer_id = travel-CustomerID ] ).
        ...
        APPEND VALUE #(  %tky        = travel-%tky
                         ...
                         %msg        = NEW zcm_rap_341(
                                           severity   = if_abap_behv_message=>severity-error
                                           textid     = zcm_rap_341=>customer_unknown
    ...
    LOOP AT travels INTO DATA(travel).
      ...
      IF travel-EndDate < travel-BeginDate.
        ...
        APPEND VALUE #( %tky               = travel-%tky
                        ...
                        %msg               = NEW zcm_rap_341(
                                                 severity  = if_abap_behv_message=>severity-error
                                                 textid    = zcm_rap_341=>date_interval
      ...
      ELSEIF travel-BeginDate < cl_abap_context_info=>get_system_date( ).
        ...
        APPEND VALUE #( %tky               = travel-%tky
                        ...
                        %msg               = NEW zcm_rap_341(
                                                 severity  = if_abap_behv_message=>severity-error
                                                 textid    = zcm_rap_341=>begin_date_before_system_date
                                                 begindate = travel-BeginDate )
   ...
   IF is_update_requested = abap_true.
         ...
         IF has_before_image = abap_true.
           ...
           IF update_granted = abap_false.
             APPEND VALUE #( %tky        = travel-%tky
                             %msg        = NEW zcm_rap_341( severity = if_abap_behv_message=>severity-error
                                                             textid   = zcm_rap_341=>unauthorized )
                           ) TO reported-travel.
           ENDIF.
...
*                      %action-Edit         = COND #( WHEN update_granted = abap_true THEN if_abap_behv=>auth-allowed ELSE if_abap_behv=>auth-unauthorized )
  ...
  METHOD is_create_granted.
    AUTHORITY-CHECK OBJECT 'ZOSTAT341'
      ID 'ZOSTAT341' DUMMY
      ID 'ACTVT' FIELD '01'.
  ...
  METHOD is_delete_granted.
    IF has_before_image = abap_true.
      AUTHORITY-CHECK OBJECT 'ZOSTA341'
        ID 'ZOSTA341' FIELD overall_status
        ID 'ACTVT' FIELD '06'.
    ELSE.
      AUTHORITY-CHECK OBJECT 'ZOSTA341'
        ID 'ZOSTA341' DUMMY
  ...
  METHOD is_update_granted.
         IF has_before_image = abap_true.
       AUTHORITY-CHECK OBJECT 'ZOSTAT341'
         ID 'ZOSTAT341' FIELD overall_status
         ID 'ACTVT' FIELD '02'.
     ELSE.
       AUTHORITY-CHECK OBJECT 'ZOSTAT341'
         ID 'ZOSTAT341' DUMMY
