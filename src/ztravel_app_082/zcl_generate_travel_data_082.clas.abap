CLASS zcl_generate_travel_data_082 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_GENERATE_TRAVEL_DATA_082 IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_082.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_082.

*   insert the new table entries
    INSERT ztravel_082 FROM TABLE @itab.
