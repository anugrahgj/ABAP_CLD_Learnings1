...
define view entity ZRAP400_I_BOOKING_0000
  as select from ZRAP400_BOOK0000
  association to parent ZRAP400_I_Travel_0000 as _Travel on $projection.TravelID = _Travel.TravelID
