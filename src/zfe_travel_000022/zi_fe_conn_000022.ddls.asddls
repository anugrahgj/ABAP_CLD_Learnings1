...
define view entity ZI_FE_CONN_000022
  as select from zfe_aconn_000022 as Connection
  association [1..1] to zi_fe_carr_000022 as _Airline on $projection.AirlineID = _Airline.AirlineID
{
