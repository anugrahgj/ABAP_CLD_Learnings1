CLASS zcl_generate_travel_data_101 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_101 IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_101.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_101.

*   insert the new table entries
    INSERT ztravel_101 FROM TABLE @itab.
