CLASS lhc_Travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    TYPES tt_travel_update TYPE TABLE FOR UPDATE zi_travel_m_101.
...
CLASS lhc_Travel IMPLEMENTATION.
  METHOD get_features.
    ...
    READ ENTITY zi_travel_m_101 FROM VALUE #( FOR keyval IN keys
                                                      (  %key                    = keyval-%key
  ...
  METHOD validate_customer.
    READ ENTITY zi_travel_m_101\\Travel FROM VALUE #(
  ...
  METHOD set_status_completed.
    ...
    MODIFY ENTITIES OF zi_travel_m_101 IN LOCAL MODE
           ENTITY travel
    ...
    READ ENTITIES OF zi_travel_m_101 IN LOCAL MODE
         ENTITY travel
