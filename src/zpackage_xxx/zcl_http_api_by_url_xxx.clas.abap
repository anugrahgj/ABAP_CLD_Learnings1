CLASS zcl_http_api_by_url_xxx DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_http_api_by_url_xxx IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    TRY.
      ...
      CATCH cx_http_dest_provider_error cx_web_http_client_error cx_web_message_error. "error handling
    ENDTRY.
  ENDMETHOD.
ENDCLASS.
