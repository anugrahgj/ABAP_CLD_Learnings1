class ZRAP400_CL_GEN_DATA_0003 definition
  public
  final
  create public .
...
CLASS ZRAP400_CL_GEN_DATA_0003 IMPLEMENTATION.


METHOD IF_OO_ADT_CLASSRUN~MAIN.
      DELETE FROM ('ZRAP400_trav0003').
     " insert travel demo data
     INSERT ('ZRAP400_trav0003')  FROM (
         SELECT
     ...
     dyn_table_name = | /dmo/booking    AS booking  |
                  && | JOIN { 'ZRAP400_trav0003' } AS z |
                  && | ON   booking~travel_id = z~travel_id |.
     DELETE FROM ('ZRAP400_book0003').
     " insert booking demo data
     INSERT ('ZRAP400_book0003') FROM (
         SELECT
           FROM (dyn_table_name)
           FIELDS
