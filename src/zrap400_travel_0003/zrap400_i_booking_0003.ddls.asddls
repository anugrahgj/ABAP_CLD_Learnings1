...
define view entity ZRAP400_I_BOOKING_0003
  as select from ZRAP400_BOOK0003
  association to parent ZRAP400_I_Travel_0003 as _Travel on $projection.TravelID = _Travel.TravelID
