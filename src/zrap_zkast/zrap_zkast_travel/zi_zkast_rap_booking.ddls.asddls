...
define view entity ZI_ZKAST_RAP_Booking
  as select from zrap_zkast_abook as Booking

  association        to parent ZI_ZKAST_RAP_Travel as _Travel     on  $projection.TravelUUID = _Travel.TravelUUID
