...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD create.
    ...
    LOOP AT it_travel_create ASSIGNING FIELD-SYMBOL(<fs_travel_create>).
      ...
      legacy_entity_in = CORRESPONDING #( <fs_travel_create> MAPPING FROM ENTITY USING CONTROL ).
      ...
      IF messages IS INITIAL.
        APPEND VALUE #( %cid = <fs_travel_create>-%cid travelid = legacy_entity_out-travel_id ) TO mapped-travel.
      ELSE.
  ...
  METHOD update.
    ...
    LOOP AT entities ASSIGNING FIELD-SYMBOL(<entity>).
      ...
      legacy_entity_x-_intx = CORRESPONDING zsrap_travel_x_1( <entity> MAPPING FROM ENTITY ).
...
CLASS lsc_ZI_RAP_Travel_U_1 DEFINITION INHERITING FROM cl_abap_behavior_saver.
  PROTECTED SECTION.
...
CLASS lsc_ZI_RAP_Travel_U_1 IMPLEMENTATION.
