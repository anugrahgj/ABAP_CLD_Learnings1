CLASS zcl_generate_travel_data_jm1 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_jm1 IMPLEMENTATION.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_jm1.

*   insert the new table entries
    INSERT ztravel_jm1 FROM TABLE @itab.
