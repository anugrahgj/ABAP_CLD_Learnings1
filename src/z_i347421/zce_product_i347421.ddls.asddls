@EndUserText.label: 'Read product data via RFC' @ObjectModel.query.implementedBy: 'ABAP:ZCL_PRODUCT_VIA_RFC_I347421'
@UI: {
  headerInfo: {
  typeName: 'Product',
...
define root custom entity zce_product_i347421
{
