...
define view entity ZI_FE_CONN_000001
  as select from zfe_aconn_000001 as Connection
  association [1..1] to zi_fe_carr_000001 as _Airline on $projection.AirlineID = _Airline.AirlineID
{
