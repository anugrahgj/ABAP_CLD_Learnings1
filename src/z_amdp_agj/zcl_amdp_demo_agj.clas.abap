...
CLASS zcl_amdp_demo_agj DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_amdp_demo_agj IMPLEMENTATION.
  ...
  USING
    /dmo/flight
    /dmo/carrier
    zcl_amdp_demo_agj=>convert_currency.
    ...
    call "ZCL_AMDP_DEMO_AGJ=>CONVERT_CURRENCY"( :flights, result );
