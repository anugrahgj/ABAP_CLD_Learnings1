CLASS zcl_generate_travel_data_260 DEFINITION
 PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_260 IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_26013857.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_26013857.

*   insert the new table entries
    INSERT ztravel_26013857 FROM TABLE @itab.
