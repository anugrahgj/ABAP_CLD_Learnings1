CLASS zivs_messages DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      gc_msgid TYPE symsgid VALUE 'ZIVS',

      BEGIN OF receiver_name_unkown,
        msgid TYPE symsgid VALUE 'ZIVS',
        msgno TYPE symsgno VALUE '001',
        attr1 TYPE scx_attrname VALUE 'MV_RECEIVER_NAME',
        attr2 TYPE scx_attrname VALUE '',
        attr3 TYPE scx_attrname VALUE '',
        attr4 TYPE scx_attrname VALUE '',
      END OF receiver_name_unkown.
...
*        previous              LIKE previous OPTIONAL
        receiver_name TYPE zivs_de_recv_name OPTIONAL
...
*        uname                 TYPE syuname OPTIONAL
    ...
    DATA:
      ...
      mv_receiver_name TYPE zivs_de_recv_name.
...
CLASS zivs_messages IMPLEMENTATION.
  ...
  METHOD constructor ##ADT_SUPPRESS_GENERATION.
    ...
    me->mv_attr3                 = attr3.
    me->mv_attr4                 = attr4.
    me->mv_receiver_name         = receiver_name.
