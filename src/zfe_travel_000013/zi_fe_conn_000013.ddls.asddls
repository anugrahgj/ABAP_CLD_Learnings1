...
define view entity ZI_FE_CONN_000013
  as select from zfe_aconn_000013 as Connection
  association [1..1] to zi_fe_carr_000013 as _Airline on $projection.AirlineID = _Airline.AirlineID
{
