CLASS zcl_generate_travel_data_aac DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_aac IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_aancos.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_aancos.

*   insert the new table entries
    INSERT ztravel_aancos FROM TABLE @itab.
