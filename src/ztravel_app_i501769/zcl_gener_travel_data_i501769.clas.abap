CLASS zcl_gener_travel_data_i501769 DEFINITION
   PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_gener_travel_data_i501769 IMPLEMENTATION.
 METHOD if_oo_adt_classrun~main.
DATA itab TYPE TABLE OF ztravel_I501769.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_I501769.

*   insert the new table entries
    INSERT ztravel_I501769 FROM TABLE @itab.
