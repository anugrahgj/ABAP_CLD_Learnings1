CLASS zcl_generate_travel_data_sk DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_sk IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_sk.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_sk.

*   insert the new table entries
    INSERT ztravel_sk FROM TABLE @itab.
