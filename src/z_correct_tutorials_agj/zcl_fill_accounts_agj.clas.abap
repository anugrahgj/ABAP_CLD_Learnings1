CLASS zcl_fill_accounts_agj DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_fill_accounts_agj IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
    DATA: lt_accounts TYPE TABLE OF zaccounts_agj.
    ...
    DELETE FROM zaccounts_agj.

    INSERT zaccounts_agj FROM TABLE @lt_accounts.
