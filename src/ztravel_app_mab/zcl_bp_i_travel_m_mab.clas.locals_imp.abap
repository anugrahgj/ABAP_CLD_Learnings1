...
CLASS lhc_travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
  ...
  PRIVATE SECTION.
    ...
    TYPES tt_travel_update TYPE TABLE FOR UPDATE zi_travel_m_mab.
...
********************************************************************************
  METHOD get_features.
    ...
    READ ENTITY zi_travel_m_mab FROM VALUE #( FOR keyval IN keys
                                                      (  %key                    = keyval-%key
  ...
  METHOD validate_agency.
    ...
    READ ENTITY zi_travel_m_mab\\travel FROM VALUE #(
...
********************************************************************************
  METHOD set_status_completed.
    ...
    MODIFY ENTITIES OF zi_travel_m_mab IN LOCAL MODE
           ENTITY travel
    ...
    READ ENTITIES OF zi_travel_m_mab IN LOCAL MODE
         ENTITY travel
