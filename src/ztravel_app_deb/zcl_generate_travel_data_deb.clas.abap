CLASS zcl_generate_travel_data_deb DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_deb IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_deb.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_deb.

*   insert the new table entries
    INSERT ztravel_deb FROM TABLE @itab.
