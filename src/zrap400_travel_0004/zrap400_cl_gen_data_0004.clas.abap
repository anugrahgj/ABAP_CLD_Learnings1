class ZRAP400_CL_GEN_DATA_0004 definition
  public
  final
  create public .
...
CLASS ZRAP400_CL_GEN_DATA_0004 IMPLEMENTATION.


METHOD IF_OO_ADT_CLASSRUN~MAIN.
      DELETE FROM ('ZRAP400_trav0004').
     " insert travel demo data
     INSERT ('ZRAP400_trav0004')  FROM (
         SELECT
     ...
     dyn_table_name = | /dmo/booking    AS booking  |
                  && | JOIN { 'ZRAP400_trav0004' } AS z |
                  && | ON   booking~travel_id = z~travel_id |.
     DELETE FROM ('ZRAP400_book0004').
     " insert booking demo data
     INSERT ('ZRAP400_book0004') FROM (
         SELECT
           FROM (dyn_table_name)
           FIELDS
