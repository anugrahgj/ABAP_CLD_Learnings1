...
**************************************************************
"! @testing BDEF:ZRAP400_I_Travel_0004
...
CLASS ltc_readonly_methods IMPLEMENTATION.
  ...
  METHOD class_setup.
    ...
    cds_test_environment = cl_cds_test_environment=>create( i_for_entity = 'ZRAP400_I_Travel_0004' ).
  ...
  METHOD validate_overall_status.
    " fill in test data
    DATA travel_mock_data TYPE STANDARD TABLE OF zrap400_trav0004.
    ...
    DATA: failed      TYPE RESPONSE FOR FAILED LATE zrap400_i_travel_0004,
          reported    TYPE RESPONSE FOR REPORTED LATE zrap400_i_travel_0004,
...
CLASS ltc_writing_methods IMPLEMENTATION.
  ...
  METHOD set_status_to_accepted.
    ...
    DATA: result      TYPE TABLE    FOR ACTION RESULT ZRAP400_i_Travel_0004\\travel~acceptTravel,
          mapped      TYPE RESPONSE FOR MAPPED EARLY ZRAP400_i_Travel_0004,
          failed      TYPE RESPONSE FOR FAILED EARLY ZRAP400_i_Travel_0004,
          reported    TYPE RESPONSE FOR REPORTED EARLY ZRAP400_i_Travel_0004,
          entity_keys TYPE STANDARD TABLE OF ty_entity_key.
    ...
    READ ENTITY ZRAP400_i_Travel_0004
  ...
  METHOD set_status_to_open.
    ...
    DATA: reported    TYPE RESPONSE FOR REPORTED LATE ZRAP400_I_Travel_0004,
          entity_keys TYPE STANDARD TABLE OF ty_entity_key.
