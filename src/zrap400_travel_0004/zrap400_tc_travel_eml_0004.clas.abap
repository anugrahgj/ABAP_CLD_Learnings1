...
CLASS zrap400_tc_travel_eml_0004 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC
  FOR TESTING
...
CLASS zrap400_tc_travel_eml_0004 IMPLEMENTATION.

  METHOD class_setup.
    " Create the test doubles for the underlying CDS entities
    cds_test_environment = cl_cds_test_environment=>create_for_multiple_cds(
                      i_for_entities = VALUE #(
                        ( i_for_entity = 'ZRAP400_I_Travel_0004' )
                        ( i_for_entity = 'ZRAP400_I_Booking_0004' ) ) ).
  ...
  METHOD deep_create_with_action.
    ...
    MODIFY ENTITIES OF ZRAP400_I_Travel_0004
     ENTITY Travel
 ...
 REPORTED DATA(reported).
    ...
    SELECT * FROM ZRAP400_I_Travel_0004 INTO TABLE @DATA(lt_travel). "#EC CI_NOWHERE
    ...
    SELECT * FROM ZRAP400_I_Booking_0004 INTO TABLE @DATA(lt_booking). "#EC CI_NOWHERE
