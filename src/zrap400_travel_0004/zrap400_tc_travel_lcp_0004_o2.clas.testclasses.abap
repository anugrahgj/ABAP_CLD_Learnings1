CLASS ltc_helper DEFINITION FOR TESTING CREATE PRIVATE.
  PUBLIC SECTION.
    CLASS-DATA:
      ...
      travel_mock_data     TYPE STANDARD TABLE OF ZRAP400_Trav0004,
      booking_mock_data    TYPE STANDARD TABLE OF ZRAP400_Book0004,
...
CLASS ltc_helper IMPLEMENTATION.
  METHOD helper_class_setup.
    ...
    mo_client_proxy = cl_web_odata_client_factory=>create_v2_local_proxy(
                                            VALUE #( service_id      = 'ZRAP400_UI_TRAVEL_0004_O2'
                                                     service_version = '0001' ) ).
    " create the test doubles for the underlying CDS entities
    cds_test_environment = cl_cds_test_environment=>create_for_multiple_cds(
                      i_for_entities = VALUE #(
                        ( i_for_entity = 'ZRAP400_C_Travel_0004'    i_select_base_dependencies = abap_true )
                        ( i_for_entity = 'ZRAP400_C_BOOKING_0004'   i_select_base_dependencies = abap_true ) ) ).
...
"!@testing SRVB:ZRAP400_UI_TRAVEL_0004_O2
...
CLASS ltc_CREATE IMPLEMENTATION.
  ...
  METHOD create.
    ...
    DATA(ls_business_data) = VALUE ZRAP400_C_Travel_0004(
    ...
    DATA ls_response_data TYPE ZRAP400_C_Travel_0004.
    ...
    READ ENTITIES OF ZRAP400_C_Travel_0004
      ENTITY Travel
    ...
    SELECT * FROM zrap400_trav0004 WHERE travel_id = @ls_response_data-TravelID
...
CLASS ltc_DEEP_CREATE IMPLEMENTATION.
  ...
  METHOD deep_create.
    ...
    INCLUDE TYPE ZRAP400_C_Travel_0004.
    TYPES to_booking TYPE STANDARD TABLE OF zrap400_c_booking_0004 WITH DEFAULT KEY.
    ...
    SELECT * FROM zrap400_book0004 WHERE travel_id = @ls_response_data-TravelID
...
CLASS ltc_UPDATE IMPLEMENTATION.
  ...
  METHOD update.
    ...
    DATA ls_business_data TYPE ZRAP400_C_Travel_0004.
...
CLASS ltc_DELETE_ENTITY IMPLEMENTATION.
  ...
  METHOD delete.
    ...
    SELECT SINGLE * FROM zrap400_trav0004  WHERE travel_id EQ @ls_entity_key-travelid INTO @DATA(ls_travel_inst) ##WARN_OK.
    ...
    SELECT SINGLE * FROM zrap400_trav0004  WHERE travel_id EQ @ls_entity_key-travelid INTO @ls_travel_inst ##WARN_OK.
...
CLASS ltc_READ_LIST IMPLEMENTATION.
  ...
  METHOD read_list.
    ...
    DATA: lt_range_agencyid   TYPE RANGE OF /dmo/agency_id,
          ...
          lt_business_data    TYPE STANDARD TABLE OF ZRAP400_C_Travel_0004.
    ...
    " assert data also from database
    SELECT * FROM zrap400_trav0004 WHERE agency_id   IN @lt_range_agencyid
