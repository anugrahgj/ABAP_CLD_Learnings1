...
********************************************************************************
  METHOD get_instance_features.
    "read entities
    READ ENTITIES OF ZRAP400_i_Travel_0004 IN LOCAL MODE
      ENTITY Travel
...
***********************************************************************************************
    ...
    SELECT MAX( travel_id ) FROM zrap400_trav0004 INTO @DATA(max_travel_id).
...
**********************************************************************
  METHOD acceptTravel.
    ...
    MODIFY ENTITIES OF ZRAP400_i_Travel_0004 IN LOCAL MODE
      ENTITY Travel
