CLASS zcl_generate_travel_data_555 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_GENERATE_TRAVEL_DATA_555 IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_555.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_555.

*   insert the new table entries
    INSERT ztravel_555 FROM TABLE @itab.
