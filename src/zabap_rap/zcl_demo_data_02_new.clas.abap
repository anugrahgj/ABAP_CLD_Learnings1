CLASS zcl_demo_data_02_new DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_demo_data_02_new IMPLEMENTATION.

  METHOD create_sample_so_header.

    DATA: lt_so_header TYPE STANDARD TABLE OF zvbak_07,
    ...
    GET TIME STAMP FIELD lv_timestamp.
     ...
     lt_so_header = VALUE #(
        ...
        INSERT zvbak_07 FROM TABLE @lt_so_header.
  ...
  METHOD create_sample_so_item.
   ...
   DATA: lt_so_item TYPE STANDARD TABLE OF zvbap_07,
         lv_timestamp TYPE timestampl.
    ...
    GET TIME STAMP FIELD lv_timestamp.
     ...
     lt_so_item = VALUE #(
        ...
        INSERT zvbap_07 FROM TABLE @lt_so_item.
  ...
  METHOD reset_sample_so_so_item.
    ...
    DELETE FROM zvbak_07.
    DELETE FROM zvbap_07.
