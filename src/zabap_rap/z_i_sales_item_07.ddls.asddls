@AbapCatalog.sqlViewName: 'ZISOITEM_7'
...
define view Z_I_Sales_Item_07 as select from zvbap_07 
    association [1..1] to Z_I_Sales_Header_07 as _SD_Head_07
    on $projection.sales_doc_num = _SD_Head_07.sales_doc_num    
{
