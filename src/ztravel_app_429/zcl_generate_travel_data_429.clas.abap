CLASS zcl_generate_travel_data_429 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_429 IMPLEMENTATION.

  method if_oo_adt_classrun~main.

    data itab type table of ztravel_429.

    itab = VALUE #( ( mykey = '02D5290E594C1EDA93815057FD946624' travel_id = '00000022' agency_id = '070001' customer_id = '000077' begin_date = '20190624' end_date = '20190628' booking_fee = '60.00' total_price =  '750.00' currency_code = 'USD'
  ...
  delete from ztravel_429.

  insert ztravel_429 from table @itab.
