...
define root view entity ZC_TRAVEL_M_I347421
  as projection on ZI_TRAVEL_M_I347421
{
      @UI.facet: [ { id:              'Travel',
                     purpose:         #STANDARD,
...
--lineItem:       [ { position: 80, importance: #LOW } ]
          identification: [ { position: 80 , label: 'Test String Label'} ],
          selectionField: [ { position: 80 } ] }

      @Search.defaultSearchElement: true
      test_string as TestStringElement
