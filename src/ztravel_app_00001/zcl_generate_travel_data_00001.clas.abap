CLASS zcl_generate_travel_data_00001 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_00001 IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_00001.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_00001.

*   insert the new table entries
    INSERT ztravel_00001 FROM TABLE @itab.
