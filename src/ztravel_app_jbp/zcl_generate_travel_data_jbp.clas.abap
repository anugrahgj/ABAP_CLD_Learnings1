CLASS zcl_generate_travel_data_jbp DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_GENERATE_TRAVEL_DATA_JBP IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_jbp.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_jbp.

*   insert the new table entries
    INSERT ztravel_jbp FROM TABLE @itab.
